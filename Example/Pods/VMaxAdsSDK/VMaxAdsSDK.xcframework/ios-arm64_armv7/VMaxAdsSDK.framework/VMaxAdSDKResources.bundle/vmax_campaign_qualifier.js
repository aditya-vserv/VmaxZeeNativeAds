...
//ios callback js method
//returns control back to userContentController
//start
function iosOnSupportedTargeting(msg){
    window.webkit.messageHandlers.onSupportedTargeting.postMessage(msg);
}

function iosOnMatchTargetingExpression(msg){
    window.webkit.messageHandlers.onMatchTargetingExpression.postMessage(msg);
}
//ios callback js method
//returns control back to userContentController
//end 
    ...
    _createClass(CampaignQualifier, [{
        ...
        value: function onMatchTargetingExpression(args) {
            try {
                ...
                iosOnMatchTargetingExpression(args);
            } catch (err) {
...
console.log('CampaignQualifier Load Called');
